...
for directory1 in subdirectories:
    os.system(f"cloc {path}{directory1}/src --json --out=/usr/cloc_output/{directory1}.json")
    for directory2 in subdirectories:
        if directory1 == directory2:
            break
        os.system(f"jsinspect {path}{directory2}/src {path}{directory1}/src -I -L --truncate 1 --ignore 'intro.js|outro.js' -r json > /usr/jsinspect_output/{directory2}-{directory1}.json ")
